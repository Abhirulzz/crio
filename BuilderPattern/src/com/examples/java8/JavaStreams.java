...
public class JavaStreams {
	...
	public static void main(String[] args) {
		List<Person> persons = List.of(new Person(1, "Alex", 100, new Department(1, "HR")),
		...
		Map<Department, Person> topEmployees = persons.stream().collect(Collectors.groupingBy(e -> e.department,
				Collectors.collectingAndThen(Collectors.maxBy(Comparator.comparingInt(e -> e.salary)), Optional::get)));
